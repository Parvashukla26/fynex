  ...
  return (
    <div className='max-w-md mx-auto p-4'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button disabled={loading} className='hover:text-darkmode font-medium text-18 bg-transparent w-full border border-primary rounded-lg py-3 text-primary hover:bg-primary disabled:opacity-50 disabled:cursor-not-allowed'>
